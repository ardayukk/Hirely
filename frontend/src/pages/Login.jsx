...
export default function Login() {
  ...
  const submit = async e => {
    ...
    setErr('');
    try {
      await login({ email, password }); // ✅ pass an object
      nav('/home');
    } catch (e) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Sign in to access your studies and evaluations.
        </Typography>
        ...
        <Box component="form" onSubmit={submit} sx={{ display: 'grid', gap: 3 }}>
          ...
          <Typography color="text.secondary" textAlign="center" mt={1}>
            ...
            <Link to="/register" style={{ color: colors.color2, textDecoration: 'none', fontWeight: 600 }}>
              Sign up
            </Link>
          </Typography>
        </Box>
